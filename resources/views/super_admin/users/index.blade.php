                        ...
                        @else
                            <div class="flex justify-center items-center gap-3">
                                <a href="{{ route('super_admin.impersonate.take', $user->id) }}"
                                   ...
                                   class="p-2.5 text-amber-600 bg-amber-50 hover:bg-amber-600 hover:text-white rounded-xl transition-all shadow-sm border border-amber-100 group-hover:scale-110"
