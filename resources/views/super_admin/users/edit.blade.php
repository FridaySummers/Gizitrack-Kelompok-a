    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <div class="p-8 border-b border-gray-50 bg-gray-50/50">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-black text-gray-800 uppercase tracking-tight">Global Account Revision</h2>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Mengedit data otoritas untuk: {{ $user->name }}</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('super_admin.users.update', $user->id) }}" class="p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Email --}}
                <div class="space-y-2">
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 text-gray-400">Alamat Email Terverifikasi</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
            ...
            {{-- Role --}}
            <div class="space-y-2">
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 text-gray-400">Otoritas Sistem</label>
            ...
            <div class="p-6 bg-amber-50 rounded-2xl border border-amber-100 space-y-4">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-xs font-black text-amber-800 uppercase tracking-widest">Keamanan & Akses</h3>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="password" name="password"
                               ...
                               class="block w-full px-4 py-3 bg-white border border-amber-200 text-gray-800 text-sm rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all outline-none font-bold placeholder:text-amber-200">
                    </div>
