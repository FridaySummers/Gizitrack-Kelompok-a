...
<div class="mb-8 p-8 bg-white rounded-2xl border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-md">
    <div class="flex items-center justify-between gap-4 flex-wrap">
        <div>
            ...
            <p class="text-gray-500 mt-1 font-medium">Kelola menu dan pantau status pengiriman makanan Anda hari ini.</p>
        </div>
        <div class="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-emerald-600 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-100/50">
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-orange-600 bg-orange-50 px-2.5 py-1 rounded-lg">Katalog</span>
        </div>
        <p class="text-xs text-gray-500 font-black uppercase tracking-widest">Total Menu</p>
        <p class="text-4xl font-black text-gray-800 mt-2">{{ $totalMenu }}</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-blue-600 bg-blue-50 px-2.5 py-1 rounded-lg">Operasional</span>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-lg">Logistik</span>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-[10px] font-black uppercase tracking-widest text-red-600 bg-red-50 px-2.5 py-1 rounded-lg">Feedback</span>
        </div>
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8 transition-all duration-300 hover:shadow-md">
    <div class="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50/30">
        <h3 class="font-black text-gray-800 text-lg uppercase tracking-tight">Pengiriman Terbaru</h3>
        <a href="{{ route('vendor.distribusi.index') }}" class="text-[10px] font-black uppercase tracking-widest text-emerald-600 hover:text-emerald-700 transition-colors flex items-center gap-1 group">
        ...
        <table class="w-full text-sm text-left text-gray-600">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td class="px-8 py-4 text-gray-800 font-black group-hover:text-emerald-600 transition-colors">
                        {{ $d->sekolah_tujuan }}
                    </td>
                    <td class="px-8 py-4 font-medium text-gray-500">
                        {{ $d->menu->name ?? '-' }}
                    </td>
                    <td class="px-8 py-4">
                        @if($d->status === 'Pending' || $d->status === 'Dikirim')
                ...
                <tr>
                    <td colspan="4" class="px-8 py-16 text-center text-gray-400 font-medium">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm font-bold text-gray-400 uppercase tracking-widest">Belum ada data pengiriman terbaru.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <a href="{{ route('vendor.menu.index') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 hover:border-emerald-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
        <div class="flex items-center">
            <div class="w-14 h-14 bg-emerald-50 rounded-xl flex items-center justify-center mr-6 group-hover:bg-emerald-100 transition-colors">
                <svg class="w-7 h-7 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
            </div>
            <div>
                <h3 class="font-black text-gray-800 text-lg uppercase tracking-tight">Kelola Menu</h3>
                <p class="text-sm text-gray-500 font-medium">Tambah atau perbarui daftar menu harian</p>
            </div>
        </div>
    </a>

    <a href="{{ route('vendor.distribusi.index') }}" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 hover:border-emerald-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
        <div class="flex items-center">
            <div class="w-14 h-14 bg-emerald-50 rounded-xl flex items-center justify-center mr-6 group-hover:bg-emerald-100 transition-colors">
            ...
            <div>
                <h3 class="font-black text-gray-800 text-lg uppercase tracking-tight">Kelola Distribusi</h3>
                <p class="text-sm text-gray-500 font-medium">Kirim makanan ke sekolah tujuan</p>
            </div>
        </div>
    </a>
</div>
