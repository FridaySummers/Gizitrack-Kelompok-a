...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-semibold text-gray-800">Kelola Semua Akun</h2>
            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    @if($user->role->value === 'super_admin')
                        <span class="bg-amber-50 text-amber-700 text-xs font-medium px-2.5 py-1 rounded-full">Super Admin</span>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    @if($user->id === auth()->id())
                        <span class="text-xs text-gray-400 italic">Akun Anda (hanya baca)</span>
                    @else
