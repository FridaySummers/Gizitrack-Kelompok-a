    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <div class="p-8 border-b border-gray-50 bg-gray-50/50">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-black text-gray-800 uppercase tracking-tight">Global Account Registration</h2>
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Registrasi entitas baru ke seluruh ekosistem GiziTrack.</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('super_admin.users.store') }}" class="p-8 space-y-6">
            @csrf
            ...
            {{-- Role --}}
            <div class="space-y-2">
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 text-gray-400">Role Otoritas</label>
