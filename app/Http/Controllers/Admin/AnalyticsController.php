...
class AnalyticsController extends Controller
{
    ...
    public function summary()
    {
        return response()->json([
            ...
            'total_sekolah' => Distribusi::distinct('sekolah_tujuan')->count('sekolah_tujuan'),
            'avg_porsi'     => round(Distribusi::avg('jumlah_porsi'), 1),
            'success_rate'  => Distribusi::count() > 0 
    ...
    public function chartData()
    {
        ...
        $dailyChart = Distribusi::selectRaw('DATE(tanggal_pengiriman) as date, count(*) as count')
            ->groupBy('date')
            ->orderBy('date', 'desc')
            ->limit(7)
            ->get()
        ...
        $topSchools = Distribusi::select('sekolah_tujuan', DB::raw('SUM(jumlah_porsi) as total_porsi'))
        ...
        $topIssues = Distribusi::select('sekolah_tujuan', DB::raw('count(*) as total_kendala'))
