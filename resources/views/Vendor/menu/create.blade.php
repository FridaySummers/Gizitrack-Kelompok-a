    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <form method="POST" action="{{ route('vendor.menu.store') }}" class="p-8 space-y-6">
            ...
            <div class="pt-6 flex flex-col sm:flex-row gap-3">
                <button type="submit" dusk="submit-menu" class="flex-1 py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-lg shadow-emerald-200 transition-all transform hover:scale-[1.02] active:scale-[0.98]">
                    Simpan Menu Baru
                </button>
